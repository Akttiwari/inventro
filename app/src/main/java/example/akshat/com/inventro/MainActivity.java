...
//
         databaseHandler = new Database(MainActivity.this);
         ...
         if (allMartialArtObjects.size() > 0) {
            ...
            for (MartialArt martialArtObject : allMartialArtObjects) {
                ...
                martialArtButtons[index].setText
                        ...
                        martialArtObject.getMaritalArtPrice());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.add_martial_art:
                Intent  addMartialArtIntent = new
                        Intent(MainActivity.this,
                        AddMartialArtActivity.class);
                startActivity(addMartialArtIntent);
                return true;
            case R.id.delete_martial_art:
                Intent deleteMartialArtIntent = new
                        Intent(MainActivity.this,
                        DeleteMartialArt.class);
               startActivity(deleteMartialArtIntent);
                return true;
            case R.id.update_martial_art:
                Intent updateMartialArtIntent=new
                        Intent(MainActivity.this,UpdateMartialArtActivity.class);
                 startActivity(updateMartialArtIntent);
                 return true;
            case R.id.material_arts_prices_reset:
                totalMartialArtsPrice=0.0;
